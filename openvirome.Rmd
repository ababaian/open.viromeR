...
params:
  ...
  search_type: GENUS                    # "LIST" or "STAT" or "SEARCH" or "GENUS"
  virome_search_term: '%%'              # --"SEARCH" : Scientific_name term
  virome_deplete_term: ''               #              Deplete from SEARCH term, '' for none
  genus_match_term: 'Eimeria'           # -- "GENUS" : NCBI Taxonomy name to exact-match
  input.path: inst/extdata/apicomplexa  # -- "LIST/STAT" : <prefix> for .stat or .list file
